...
mysqlTarFile="mysql-8.0.16-linux-glibc2.12-x86_64.tar.xz"
...
then
    ...
    tar xvf ${mysqlTarFile} -C  ${base_dir} --strip-components 1
...
mysqlx_socket = /${data_root_dir}/mysql/${mysql_port}/data/mysqlx.sock
